...
def print_current_used():
    ...
    for pos in range(len(ourdb)-1,-1,-1):
        ...
        for objid in ourdb[pos][2]:
            ...
            if "{http://thermal.cnde.iastate.edu/datacollect/provenance}wasgeneratedby" in element.attrib:
                print("%s generated by %s" % (elementhrefc.humanurl(),element.attrib["{http://thermal.cnde.iastate.edu/datacollect/provenance}wasgeneratedby"]))
                pass
            else:
